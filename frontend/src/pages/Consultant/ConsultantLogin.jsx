...
import consultant from "../../assets/consultantImg.png";
const ConsultantLogin = () => {
  ...
  const handleConsultantLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://localhost:5137/consultantauth/consultantlogin", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        ...
        Cookies.set("consultantLogin", responseData.token, { expires: 1 });
    ...
    <form onSubmit={handleConsultantLogin}>
      <div class="py-16">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          <img class="hidden lg:block lg:w-1/2 bg-cover" src={consultant} />
